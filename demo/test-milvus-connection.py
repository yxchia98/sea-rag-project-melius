...
# connection_string = f"postgresql://{os.environ['DB_USER']}:{os.environ['DB_PASSWORD']}@{os.environ['DB_URL']}:{os.environ['DB_PORT']}?sslmode={os.environ['SSL_MODE']}&connect_timeout=10"
...
vector_store = MilvusVectorStore(uri="milvus.bala-mtr.svc.cluster.local:19530", dim=1536, overwrite=True)
